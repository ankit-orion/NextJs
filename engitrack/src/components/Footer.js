      ...
      <footer className="bg-white text-black py-6">
        <div className="container mx-auto flex flex-col md:flex-row justify-between items-center pl-20 pr-20 pt-1">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            <a href="https://x.com/returnUsername" aria-label="Twitter" target="_blank" rel="noopener noreferrer">
            ...
            <a href="https://www.linkedin.com/in/ankit-orion/" aria-label="LinkedIn" target="_blank" rel="noopener noreferrer">
              <svg className="w-6 h-6 fill-current text-black hover:text-gray-700" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="https://github.com/ankit-orion" aria-label="GitHub" target="_blank" rel="noopener noreferrer">
              <svg className="w-6 h-6 fill-current text-black hover:text-gray-700" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
