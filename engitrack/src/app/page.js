    ...
    <div className={`flex flex-col items-center justify-start min-h-screen text-center px-4 py-8 pt-16 sm:pt-28 ${roboto.className}`}>
      ...
      <div className="max-w-4xl mx-auto px-4 py-12 text-center">
        ...
        <p className="mt-4 sm:mt-6 lg:mt-8 text-lg sm:text-xl">
          ...
          <br className="hidden sm:inline" /> with Engitrack's comprehensive internship program.
        </p>

        <div className="mt-8 sm:mt-12 space-y-4 sm:space-y-0 sm:space-x-4 flex flex-col sm:flex-row justify-center">
          <Link href="/join">
            <button className="w-full sm:w-auto bg-primary text-primary-foreground hover:bg-primary/90 h-12 px-6 rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50">
              Apply Now
            </button>
          </Link>

          <Link href="/explore">
            <button className="w-full sm:w-auto bg-transparent text-black hover:text-gray-700 h-12 px-6 rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50">
              Explore
            </button>
          </Link>
        </div>
      ...
      <div className="max-w-4xl mx-auto px-4 pt-16 flex flex-col lg:flex-row items-center lg:items-start">
        <div className="lg:w-1/2 text-center lg:text-left mb-8 lg:mb-0">
          ...
          <p className="mt-6 sm:mt-8 lg:mt-12 text-lg">
            Engitrack is a leading online platform in India that connects engineering students 
            <br className="hidden sm:inline" /> with internships and offers services like resume building and career counseling.
          </p>
        </div>
        <div className="lg:w-1/2 lg:ml-12 flex justify-center lg:justify-end relative">
          <Image 
            src="https://images.unsplash.com/photo-1591980607162-923fa31e8240?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" 
            alt="hero"
            width={500}
            height={500}
      ...
      {/* Internship Connection Platform section */}
      <div className="max-w-7xl mx-auto px-4 pt-12 sm:pt-16 md:pt-20 lg:pt-24">
        <div className="text-center mb-8 sm:mb-12">
          ...
          <p className="mt-2 sm:mt-4 text-base sm:text-lg md:text-xl">
            Explore our services for resume building, interview preparation, and career counseling today
          </p>
        </div>
