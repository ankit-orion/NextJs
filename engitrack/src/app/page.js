...
export default function HomePage() {
  return (
    <div
      className={`flex flex-col items-center justify-start min-h-screen text-center px-4 py-8 pt-16 sm:pt-28 ${roboto.className}`}
    >
      ...
      <p className="mt-8 sm:mt-12 lg:mt-16">
        Unlock endless opportunities in the world of corporate <br /> with
        Engitrack's comprehensive internship program.
      </p>
      ...
      <div>
        <Link href="/explore">
          <button
            className="bg-transparent text-black hover:text-gray-700 h-12 
      ...
      <div className="max-w-4xl mx-auto pt-40">
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-normal leading-tight">
          <span className="block mb-2 sm:mb-4">Internship Connection</span>
          <span className="block mb-2 sm:mb-4">Platform</span>
        </h1>
        <p className="mt-8 sm:mt-6 lg:mt-12">
      Explore our services for resume building, <br/> interview preparation, and career counseling today
      </p>
